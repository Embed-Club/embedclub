 ...
 *
 * The reasoning: member-authored images are site content and belong in the
 ...
 * else's problem, and members can open the folder directly.
 *
...
/**
 * Google's 403s here are configuration problems a member can actually fix,
