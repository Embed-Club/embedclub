    ...
    >
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          // The panel stays mounted when closed, parked off-screen. Left
          // scrollable it kept painting its scrollbar over the page after the
          // menu had shut, so scrolling is only on while it is actually open.
          className="staggered-menu-panel absolute top-0 right-0 h-full flex flex-col p-[6em_2em_2em_2em] z-10 backdrop-blur-[12px] pointer-events-auto"
          data-open={open}
          style={{
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: var(--sm-bg,#ffffff); color: var(--sm-fg,#000000); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow: hidden; z-index: 10; }
.sm-scope .staggered-menu-panel[data-open='true'] { overflow-y: auto; }
