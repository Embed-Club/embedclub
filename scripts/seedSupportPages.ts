 ...
 * Re-running overwrites it, so once an officer has edited the wording in the
...
const CONTACT = richText([
  paragraph([
    text(
      'Embed Club is a student-run club at P.A. College of Engineering, Mangalore. Write or call us about anything to do with an event, a form, or the club in general - an officer reads and replies. Common questions are answered further down the page.',
    ),
  ]),
  paragraph([
    bold('Writing in? '),
