...
const PRIVACY = richText([
  ...
  list("bullet", [
    ...
    [
      bold("Your phone number"),
      text(" - used to reach you about the event you registered for."),
    ],
    [
  ...
  list("bullet", [
    [
      bold("To run the event"),
      text(" - registering you, and knowing who is coming."),
    ],
    [
    ...
    [
      ...
      text(
        " - sent to the email address you gave, either on registering or after the event.",
      ),
    ],
    [
    ...
    [
      ...
      text(
        " - checking the payment screenshot against the registration, for paid events.",
      ),
    ],
  ]),
  paragraph([
...
const TERMS = richText([
  ...
  list("bullet", [
    [
      bold("Refunded"),
      text(
        " - the event is cancelled by the club, or does not take place as announced.",
      ),
    ],
    [
      bold("Not refunded"),
  ...
  paragraph([
    text(
      "Where a refund is due, it goes back to the UPI account the payment came from. Write to ",
    ),
    bold(CONTACT),
  ...
  paragraph([
    text(
      "We photograph our events and publish some of those photographs in the ",
    ),
