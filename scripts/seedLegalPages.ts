...
const PRIVACY = richText([
  paragraph([
    text(
      'Embed Club is a student-run club at P.A. College of Engineering, Mangalore. This policy covers the club website and the registration and feedback forms hosted on it. Anything you send us through this site is handled by club officers, using the shared club account ',
    ),
    bold(CONTACT),
    text('.'),
  ]),
  ...
  paragraph([
    text(
      'Members are not self-registered. There is no sign-up form and no application: officers add members in the admin panel after someone has taken part in the club and been given a role. A member profile holds a name, photo, short bio, the years active, and any GitHub or LinkedIn links the member has chosen to share. All of that is public on the ',
    ),
  ...
  paragraph([
    text(
      'Access to all of these is through the club account, held by the current officers. Some of these services store data outside India.',
    ),
  ]),
...
const TERMS = richText([
  ...
  paragraph([
    text(
      'Embed Club is a student-run club at P.A. College of Engineering, Mangalore. It is not a company and does not trade. Events are organised by student officers, and the club account ',
    ),
    bold(CONTACT),
  ...
  paragraph([
    text(
      'College rules apply at every club event. Equipment lent to you during a workshop is the club’s, and is to be returned in the condition it was given. Officers may ask anyone disrupting an event to leave, without a refund.',
    ),
  ]),
  ...
  paragraph([
    ...
    text(
      ' and on club social media. If you would rather not appear, tell an officer at the event or write to us afterwards and we will take the picture down.',
    ),
  ]),
